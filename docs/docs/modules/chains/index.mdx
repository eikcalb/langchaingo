...
### Run
If a chain only expects one input and returns a string the run function can be used to execute the chain. The previous example could therefore be written like this:
